...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.evaluate("""() => {
            const btns = document.querySelectorAll('button');
            for (let btn of btns) {
                if (btn.textContent.includes('Webhooks')) {
                    btn.click();
                }
            }
        }""")
        ...
        page.evaluate("""() => {
            const btns = document.querySelectorAll('button');
            for (let btn of btns) {
                if (btn.textContent.includes('Add Webhook')) {
                    btn.click();
                }
            }
        }""")
        ...
        page.screenshot(path="/home/jules/verification/screenshots/webhooks_tab_added.png")
        print("Screenshot saved to /home/jules/verification/screenshots/webhooks_tab_added.png")
